...
§
Lead-gen Agency AdOps OS planning artifacts live under `/opt/data/product-planning/leadgen-adops-os/`; versioned PRD/architecture docs are kept there, with research-wave reports under `agent-research/`.